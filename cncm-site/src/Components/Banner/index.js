...
import { withStyles, Grid, Typography, Tooltip, IconButton, Grow } from '@material-ui/core';
...
class Banner extends React.Component {
  ...
  componentDidMount() {
    this.setState({ hideGrow: !this.props.bannerDisplay, bannerDisplay: this.props.bannerDisplay });
  }
  ...
  render() {
    ...
    return (
      <Grow style={{display: hideGrow ? 'none' : 'block'}} timeout={1000} in={!showGrow}>
          ...
          <Grid container justify="space-between" direction="row" alignItems="center">
            <Grid item>
              <Typography inline variant="body1" align="left">
                <Grid container justify="space-between" direction="row" alignItems="center">
                  <Grid item>
                    <Tooltip title="Alert Notification" aria-label="alert notification">
                      <IconButton>
                        <FiAlertCircle />
                      </IconButton>
                    </Tooltip>
            ...
            <Grid item>
              <Typography inline variant="body1" align="right">
                <Tooltip title="Close Notification" aria-label="close notification">
